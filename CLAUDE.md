...
- `cmd/` — Cobra root + commands (init, migrate, migrate-projects, migrate-memory, migrate-mailbox, status, edit, archive, project, goal, memory, dream, send, version, update)
